...
import { Chat, Message, QuickReply, ScheduledMessage } from '../types';
import { formatTime } from '../utils/formatters';
import { MoreVertical, Search, Phone, Video, Clock, PlayCircle, PauseCircle, Trash2 } from 'lucide-react';
...
interface Props {
  chat: Chat | null;
  messages: Message[];
  scheduledMessages?: ScheduledMessage[]; // Nuevo prop
...
export const ChatWindow: React.FC<Props> = ({ 
  ...
  useLayoutEffect(() => {
    scrollToBottom();
  }, [messages, chat?.id, scheduledMessages]);
